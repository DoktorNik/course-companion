...
<div class = "flex flex-row-reverse justify-end">
    ...
    <label class="text-3xl cursor-pointer opacity-40 hover:opacity-100 peer peer-hover:opacity-100 peer-checked:opacity-100" for="{{$id}}5" title="{{$tooltip}} 5/5">{!!$code!!}</label>
    <input class="hidden peer peer-checked:opacity-100" type="radio" id="{{$id}}4" name="rating{{ucfirst($id)}}" value="4">
    <label class="text-3xl cursor-pointer opacity-40 hover:opacity-100 peer peer-hover:opacity-100 peer-checked:opacity-100" for="{{$id}}4" title="{{$tooltip}} 4/5">{!!$code!!}</label>
    <input class="hidden peer peer-checked:opacity-100" type="radio" id="{{$id}}3" name="rating{{ucfirst($id)}}" value="3">
    <label class="text-3xl cursor-pointer opacity-40 hover:opacity-100 peer peer-hover:opacity-100 peer-checked:opacity-100" for="{{$id}}3" title="{{$tooltip}} 3/5">{!!$code!!}</label>
    <input class="hidden peer peer-checked:opacity-100" type="radio" id="{{$id}}2" name="rating{{ucfirst($id)}}" value="2">
    <label class="text-3xl cursor-pointer opacity-40 hover:opacity-100 peer peer-hover:opacity-100 peer-checked:opacity-100" for="{{$id}}2" title="{{$tooltip}} 2/5">{!!$code!!}</label>
    <input class="hidden peer peer-checked:opacity-100" type="radio" id="{{$id}}1" name="rating{{ucfirst($id)}}" value="1">
    <label class="text-3xl cursor-pointer opacity-40 hover:opacity-100 peer peer-hover:opacity-100 peer-checked:opacity-100" for="{{$id}}1" title="{{$tooltip}} 1/5">{!!$code!!}</label>
</div>
